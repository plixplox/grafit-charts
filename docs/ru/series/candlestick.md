...
каждая точка занимает бэнд, выходные не оставляют дыр. Ось `time` тоже работает — тогда
сессии стоят на настоящем расстоянии друг от друга, вместе с выходными.
