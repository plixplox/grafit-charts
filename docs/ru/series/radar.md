...
У радара обычно по мере на серию, поэтому `tooltip.mode: 'shared'` читается здесь
так же, как на линейном графике: спица под курсором отвечает сразу за все серии,
каждая подсвечена на своей вершине, и ни одна не приглушена. См.
[Тултип](/ru/interactivity/tooltip#режимы).
