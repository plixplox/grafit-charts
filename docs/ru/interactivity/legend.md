...
| `maxWidth`                | `Length`                     | размер чарта         | предел ширины легенды ([ниже](#ограничение-размера))                          |
| `maxHeight`               | `Length`                     | размер чарта         | предел высоты легенды ([ниже](#ограничение-размера))                          |
