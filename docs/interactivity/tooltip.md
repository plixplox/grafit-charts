...
A 48-pixel KPI strip in a frame that clips its content, like a dashboard card.
Hover it, then switch the tooltip inside the chart with the button below to see
the difference:

::: chart-example tooltip-outside 48
